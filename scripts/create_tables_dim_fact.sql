...
CREATE TABLE IF NOT EXISTS sales_mart.fact_sales(
	...
	, sales_date_key int --NOT NULL -- refernce dim_date
	, customer_id varchar(100) --NOT NULL -- reference dim_cutomer AND dim_customer_profile
	, product_id varchar(20) ---NOT NULL
	...
	, sales_value NUMERIC(9,2) --NOT NULL -- quantity * unit_price
	, sales_cost NUMERIC(9,2)  --NOT NULL -- quantity * unit_cost
	, margin NUMERIC(9,2) --NOT NULL -- sales_value - sales_cost
